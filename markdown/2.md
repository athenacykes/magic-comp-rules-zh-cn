...
<b id='cr205-2a'>205.2a</b> 牌类别包括神器、战役、诡局、生物、地城、结界、瞬间、亲缘、地、异象、时空、鹏洛客、阴谋、法术，以及先锋。参见[第3章](3)，“牌类别”。   
